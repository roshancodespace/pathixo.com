...
export default function ContactUs() {
  ...
  return (
    <section className="min-h-screen bg-black relative overflow-hidden py-24 px-6" id='contact'>
      {/* Background accents */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-purple-900/20 blur-[200px] rounded-full" />
        <div className="absolute bottom-0 right-1/3 w-[300px] h-[300px] bg-indigo-900/20 blur-[180px] rounded-full" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="text-white space-y-10 flex flex-col justify-center">
          {/* Gradient bar instead of single color */}
          <div className="w-1 h-20 bg-gradient-to-b from-purple-500 to-indigo-600 rounded-full"></div>
          ...
          <div className="flex gap-4 mt-8">
            {[Facebook, Twitter, Linkedin, Github].map((Icon, idx) => (
              <button
                key={idx}
                className="w-10 h-10 border border-gray-700 rounded-full flex items-center justify-center 
        ...
        <div className="relative my-auto">
          {/* Corner accents (gradient borders) */}
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-transparent border-b border-gray-700 pb-2 text-white placeholder-gray-500 
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-indigo-500 hover:to-purple-600 
                  text-black font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-[1.02] tracking-wider uppercase"
              >
                Send Message
              </button>
            </form>
