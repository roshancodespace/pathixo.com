    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center text-center px-4 transition-all">
                ...
                <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Build, scale, and manage your digital presence with Pathixo&apos;s all-in-one SaaS platform</p>
